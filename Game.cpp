...
int main()
{
	...
	window->setpInfo("THERE ARE SEVERAL PLANKS OF WOOD NAILED TO THE DOOR. THE WINDOW NEXT TO THE DOOR\nIS A LITTLE CRACKED."); 
	window->setOccur("GLASSBALL WAS THROWN AT THE WINDOW. THE WINDOW BREAKS. YOU HEAR THE SOUND OF THE\nENERGY OF THE UNIVERSE UNLEASED FROM THE GLASSBALL.\nNOTHING HAPPENED...\nTHE WORLD SEEMS TO BE STILL INTACT.");
