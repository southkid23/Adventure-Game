...
int main()
{
	Room* VillageCentLocs[4] = {LargeHouse = "North",Graveyard = "East",Shack = "South",Bank = "West"};
	Room* ShackLocs[4] = {Village};
	Room* BankLocs[4] = {Villagecenter;
	/////////////////////////////////////////////////////////////////////
	Room* VillageCent = new Room("Village Center",VillageCentlocs,"In the center of the village there is a small well. Next to the well is an old man with a long beard and a long staff. He appears to be very wise and very lost. To the south of the center is the small shack from where the player came from. To the East is a fenced graveyard. To the West is a bank. To the North is a large house.");
	Room* Shack = new Room("Shack",ShackLocs,"You wake up in a shack. A little girl that tells you how she dragged you from outside. She tells you that there was a recent fire in the village and that she managed to save you. In this room there is an apple, a butter knife, and a journal. The door leads to outside.");
