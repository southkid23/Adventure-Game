...
int main()
{
	...
	List* vItems; List* sItems; List* bItems; List* gItems; List* lItems;
	...
	Item* crowbar = new Item("CROWBAR", "A rusty, old crowbar. Seems sturdy.", false); crowbar->setOccur("Door gets broken down.");
