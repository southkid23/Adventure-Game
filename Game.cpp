...
{
	system("color 2");
	Room* Shack;Room* VillageCent;Room* Graveyard;Room* Bank;Room* LargeHouse; Room* uTomb; Room* bRoom; Room* storage; Room* backyard;
	...
	Item* pStone = new Item("PHILOSOPHER'S_STONE", "YOU FEEL A STRANGE POWERFUL AURA JUST BY HOLDING ONTO THIS STONE.", true);
	...
	begger->setOccur("\"OH DING! THERE YOU ARE! NOW, LET US CONTINUE OUR JOURNEY TO THE WEST. TO SHOW\nMY APPRECIATION, TAKE THIS MY YOUNG LAD.\"\n\nHE GAVE YOU A PICKLOCK.\n\n");
